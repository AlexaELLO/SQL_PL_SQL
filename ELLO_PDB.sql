...
CREATE USER FLOWER_SHOP
IDENTIFIED BY popo12
DEFAULT TABLESPACE tbs_01
TEMPORARY TABLESPACE tbs_tem_01
QUOTA 50M ON tbs_01;
...
CREATE TABLE FLOWER_SHOP.DEPARTMENTS (
    dept_id NUMBER NOT NULL,
    department VARCHAR2(50) NOT NULL,
    phone_of_department NUMBER(5) NOT NULL,
    CONSTRAINT dept_pk PRIMARY KEY (dept_id)
    );
    
COMMIT;

GRANT ALL ON FLOWER_SHOP.DEPARTMENTS TO FLOWER_SHOP;

COMMIT;

GRANT CREATE SESSION TO FLOWER_SHOP;